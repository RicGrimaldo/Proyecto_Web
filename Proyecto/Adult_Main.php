...
<head>
    ...
    <title>Categor&iacute;as +18</title>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="opcionesMenus">
        ...
        <div class="flex-container">
            ...
            <div class="categories">
                <h4 class="titulo">Gore</h4>    
                <div class="sample" id="cat_gore"></div>
            </div>
            
            <div class="categories">
                <h4 class="titulo">Accion</h4>    
    ...
    <script type="text/javascript" src="MetodosJS/metodos_adults.js"></script>
