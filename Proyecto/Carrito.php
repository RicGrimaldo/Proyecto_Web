...
<head>
    ...
    <link rel="stylesheet" href="EstilosCSS/EstilosCarrito.css">
...
<nav class="navbar navbar-expand-lg navbar-light py-md-2" id="cabeceraPrincipal">
        ...
        <button class="darkModeSwitch" id="switchb">
            ...
            <div class="collapse navbar-collapse justify-content-center order-2" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav justify-content-center nav-pills nav-fill">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="Carrito.php" id="carritoNav" ><img src="Imagenes/Header_Footer/carritob.png" class="d-inline-block align-top" alt="carrito" width="30px"></a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="container" id="container">
        <div class="titulos">
        <h1 style="float: left;">Carrito</h1>
        <div class="botonesCabeceraCarrito">
            <button style="float: right;" id="precioTotal" class="btn-Total">Pagar: $0.00</button>
            <button style="float: right;" id="btnVaciar" class="btn-Total">Vaciar carrito</button>
            <button style="float: right;" id="btnQuitarSeleccion" class="btn-Total">Quitar selecci&oacute;n</button>
        </div>
        </div>
        ...
        <div class="col-12 mb-2 col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h5>Titulo</h5>
                    <p>Precio</p>
                    <button class="btn btn-dark" data-id="3">Agregar</button>
                </div>
            </div>
        </div>
    </template>
    ...
    <script src="MetodosJS/CarritoMetodos.js"></script>
</body>
</html>
