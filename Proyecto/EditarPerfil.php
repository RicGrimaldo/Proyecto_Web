...
<nav class="navbar navbar-expand-lg navbar-light py-md-2" id="cabeceraPrincipal">
        ...
        <article class="register-cont">
            ...
            <div  id="response" class="form-register">
                <form id="form" style="text-align: center;">
                    ...
                    <label class=controls ><?php echo $username?></label><br><br>

                    <label class=lab >E-mail</label><br>
                    <label class=controls ><?php echo $userEmail?></label><br><br>

                    <label class=lab >Usuario</label><br>
                    <label class=controls ><?php echo $userkey?></label><br><br>

                    <label class=lab >Fecha de nacimiento</label><br>
                    <label class=controls ><?php echo $userBirth ?></label><br><br>

                    <label class=lab >Contraseña</label><br>
                    <label class=controls >********</label><br><br>
                    ...
                    <button type="button" class="btn btn-danger btn-lg" id="btnEliminarCuenta">Eliminar cuenta</button>
    ...
    <script src="MetodosJS/MetodoEliminar.js"></script>
